USE [master]
GO
/****** Object:  Database [DB_Users]    Script Date: 01.08.2024 12:13:27 ******/
...
GO
ALTER DATABASE [DB_Users] SET COMPATIBILITY_LEVEL = 160
GO
...
GO
EXEC sys.sp_db_vardecimal_storage_format N'DB_Users', N'ON'
GO
...
USE [DB_Users]
GO
/****** Object:  Table [dbo].[DB_Users]    Script Date: 01.08.2024 12:13:27 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[DB_Users](
	...
	[internal_phone] [nvarchar](10) NULL,
